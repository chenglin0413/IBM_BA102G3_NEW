	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllreta.jsp的請求
			...
			try {
				...
				/***************************3.查詢完成,準備轉交(Send the Success view)************/
				req.setAttribute("retaVO", retaVO);         // 資料庫取出的retaVO物件,存入req
				String url = "/front-end/restaurant/reta/update_reta_input.jsp";
		...
		if ("update".equals(action)) { // 來自update_reta_input.jsp的請求
...
//			try {
				...
				Integer reta_number = null;
				Integer reta_status = null;
				Integer reta_grant = null;
				Date reta_date = null;
				Integer reta_rank_res = null;
				String reta_review = null;
				Date reta_reviewdate = null;
				Date rest_rpdate = null;
				String rest_rpcomm = null;
				Integer rest_rpstatus = null;
