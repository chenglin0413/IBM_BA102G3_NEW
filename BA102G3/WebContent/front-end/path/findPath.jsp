...
<div>
						<label><font color="red">我的地圖1</font></label>
     					...
     					<div class="input-group">
       							...
       							航空公司<input type="text" name="flsc_airlinecode1" value="HX"><br>
       							班機編號<input type="text" name="flsc_flno1" value="1852"><br>
       							
       							<br><br>

       							出發日期<input type="text" name="flsc_sdate2" value="2017-08-20"><br>
       							航空公司<input type="text" name="flsc_airlinecode2" value="JL"><br>
       							班機編號<input type="text" name="flsc_flno2" value="5040"><br><br>
