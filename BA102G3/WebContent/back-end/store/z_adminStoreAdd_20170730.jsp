                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        ...
                        <ul id="shop" class="collapse in">
                            <li>
                                <a href="admin-shop-wait.html">待審核</a>
                            </li>
                            <li>
		...
		<c:forEach var="message" items="${errorMsgs}">
			<li>${message}</li>
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                <label class="input-group-addon">商店描述</label>
                                <input type="text" name="store_describe" value="<%= (storeVO==null)? "" : storeVO.getStore_describe()%>" class="form-control">
                            </div><br>
