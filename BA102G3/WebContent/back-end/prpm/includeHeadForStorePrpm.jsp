    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> 您好  ${sysuVO.sysu_lastname}${sysuVO.sysu_firstname} <b class="caret"></b></a>
		...
		<c:forEach var="authVO1" items="${listauth}" >
			<c:if test="${authVO1.func_id == '4100005'}" var="condition" scope="page" >
                    ...
                    <li class="active">
                        ...
                        <ul id="storeprom" class="collapse in">
                            <li>
                                <a href="<%= request.getContextPath() %>/back-end/prpm/adminStorePrpmNow.jsp">目前促銷專案</a>
                            </li>
                            <li>
                                <a href="<%= request.getContextPath() %>/back-end/prpm/adminStorePrpmQuery.jsp">查詢/修改</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="restprom" class="collapse">
                            <li>
                                <a href="<%= request.getContextPath() %>/back-end/prpm/adminRestPrpmNow.jsp">目前促銷專案</a>
                            </li>
                            <li>
                                <a href="<%= request.getContextPath() %>/back-end/prpm/adminRestPrpmQuery.jsp">查詢/修改</a>
                            </li>
                        </ul>
                    </li>
